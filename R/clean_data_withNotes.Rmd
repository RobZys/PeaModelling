...
whole_plant <- combined %>% 
  ...
  mutate(# subsample fresh/dry weight 
         ...
         partFW = ifelse(partFW == 0, Final_ResidueSubFW + Final_podFW + Final_grainFW, partFW),
         partDW = ifelse(partDW == 0, Final_ResidueSubDW + Final_podDW + Final_grainDW, partDW),
         ...
         SSDW = ifelse(SSDW == 0, SSFW * (partDW/partFW), SSDW)
